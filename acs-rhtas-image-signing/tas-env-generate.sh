...
export TUF_URL=https://tuf-trusted-artifact-signer.${BASE_HOSTNAME}
export COSIGN_FULCIO_URL=https://fulcio-server-trusted-artifact-signer.${BASE_HOSTNAME}
export COSIGN_REKOR_URL=https://rekor-server-trusted-artifact-signer.${BASE_HOSTNAME}
